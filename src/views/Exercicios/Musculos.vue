    ...
    <el-table :data="tableData" style="width: 100%" border>
      <el-table-column type="expand">
        <template #default="props">
          <p>Imagem:</p>
          <br />
          <img :src="props.row.imagem" alt />
        </template>
      </el-table-column>
      <el-table-column label="Nome do músculo" prop="nome"></el-table-column>
    </el-table>
    <div class="text-center">
      <br />
      <br />
    ...
    <div class="modal__content" v-loading="load">
      <div class>
        <form @submit.prevent="SendImage()">
          <div class="col-md-12">
            <h4>Cadastro de Músculo</h4>
          </div>

          <div class="col-md-12">
            <span>Nome do Músculo</span>
          ...
          <div class="col-md-12">
            ...
            <label
              for="fileImage"
              style="background: #204f7f; color: white; padding: 1vw; border-radius: 5px; margin: 10px 2px 6px 5px;"
            ...
            <img v-if="render" :src="render" width="150" alt="Thumb preview..." />
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        ...
        {
          nome: 'Triceps',
          imagem: 'https://www.iespe.com.br/wp-content/uploads/2016/03/O-m%C3%BAsculo-e-suas-estruturas-parte-2-site.jpg',
        },
        {
          nome: 'Triceps',
          imagem: 'https://www.iespe.com.br/wp-content/uploads/2016/03/O-m%C3%BAsculo-e-suas-estruturas-parte-2-site.jpg',
  ...
  methods: {
    ...
    SendImage() {
      this.load = true;
      console.log('inicia', this.fileImage)
      let data = {
