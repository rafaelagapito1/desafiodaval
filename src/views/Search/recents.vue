          ...
          >
            <div class="bg-color margin__top">
              <div class="padding_left_box p_top">
                ...
                <div class="subcategorie" v-if="CategorieStatus">
                  <h5 style="margin-top: 20px">SubCategoria</h5>
                  <div
                    class="tamanhos"
...
export default {
  ...
  methods: {
    ...
    getResultSearch() {
      ...
      Products.SearchProducts(this.dataSearch)
        .then((r) => {
          ...
          this.resultProducts = this.orderName(this.productsBkp);
          this.load = false;
    ...
    addSubcategory(value) {
      ...
      var liberado2 = true;
      let i = 0;
      for (; i <= this.SubCategorie.length - 1; i++) {
        if (this.SubCategorie[i] == value) {
          liberado2 = false;
          alert("ok1");
        } else if (this.SubCategorie[i] == value) {
          liberado2 = true;
          alert("ok2");
        }
      }
