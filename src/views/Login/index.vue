<template>
    <div class="login">
        <div class="login-form text-center" v-loading="load">
            <form class="text-left" @submit.prevent="userLogin" v-if="!internalClientOn">
                <div class="form-group email">
                    <label for="exampleInputEmail1">
                        <i style="margin-right: 5px; font-size: 22px" class="el-icon-user-solid"></i>Endereço de E-mail
                    </label>
                ...
                <div class="form-group password">
                    <label for="exampleInputPassword1">
                        <i style="margin-right: 5px; font-size: 20px" class="fas fa-lock"></i>Senha
                    </label>

                    <input type="password" class="form-control" v-model="dataLogin.PASSWORD" />
