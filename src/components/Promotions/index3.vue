                ...
                <div class="product-card product-card--hidden-actions">
                  ...
                  >
                    <div class="product-card__badge product-card__badge--sale">
                      <p style="transform: rotate( 314deg ); position: absolute; top: 22px; animation-delay: 5; left: 15px;font-weight: bold;">-{{ getPercent(product) }}</p>
                    </div>
                      <div class="new" style="padding-left: 15px;">
                <p style="text-decoration: line-through; font-size: 15px; color: rgb(47, 85, 150);    font-weight: bold; padding-left: 15px; transform: rotate( 314deg ); position: absolute; top: 55px; animation-delay: 5; left: 15px;">  {{ currencyBRL(product.SALE_PRICE) }}</p>
                </div>
                  </div>
...
.product-card__badge--sale {
  background: #4466a1;
  background: url(../../assets/images/discount2.svg);
